...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "- rag_search(query:str, content_type:str|None, group_by:str|None, limit:int=10, show_content:bool=True, use_hybrid:bool=True): Universal RAG search (hybrid by default).\n"
