...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "     * Questions about 'recent changes', 'who changed X', 'state transitions', 'time logged' → content_type='timeline'\n"
        ...
        try:
            ...
            with (span_cm if span_cm is not None else contextlib.nullcontext()) as run_span:
                ...
                routing_instructions = SystemMessage(content=(
                    ...
                    "     • 'recent changes', 'who changed X', 'state transitions', 'time logged' → content_type='timeline'\n"
