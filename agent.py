...
# Tracing shim (no-op replacement for OpenTelemetry/Phoenix)
...
class PhoenixSpanManager:
    """No-op span manager preserving interface."""
...
class PhoenixCallbackHandler(AsyncCallbackHandler):
    ...
    def cleanup(self):
        """No-op cleanup; Phoenix collector disabled"""
        try:
            print("Tracing cleanup (noop)")
        except Exception:
            pass
