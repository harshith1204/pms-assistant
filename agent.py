...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "   - IMPORTANT: Returns only a compact summary (title preview + confirmation) to save tokens.\n"
    "   - Full content is generated but NOT returned to avoid expensive LLM re-processing.\n"
    ...
    "  NOTE: Returns summary only - full content NOT included to save tokens.\n\n"
        ...
        try:
            ...
            with (span_cm if span_cm is not None else contextlib.nullcontext()) as run_span:
                ...
                routing_instructions = SystemMessage(content=(
                    ...
                    "3) Use 'generate_content' to CREATE new work items or pages.\n"
                    "   - CRITICAL: Returns compact summary only (NOT full content) to save tokens.\n"
                    ...
                    "  REQUIRED: content_type ('work_item'|'page'), prompt.\n"
                    "  OPTIONAL: template_title, template_content, context.\n"
                    "  NOTE: Returns summary only to save tokens.\n\n"
