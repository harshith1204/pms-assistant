...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "3) Use 'generate_content' to CREATE: project, epic, module, feature, user_story, cycle, work_item, page.\n"
    "   Single: generate_content(content_type='work_item', prompt='Bug: Login fails on mobile')\n"
    "   Full project: generate sequentially → project → epics → modules → features → user_stories → cycles → work_items\n"
