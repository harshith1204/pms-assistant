...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "   - **project**: Top-level container. Has name, ID, goals, scope. Example: 'E-commerce Platform for SMBs'\n"
    "   - **epic**: Large strategic initiative spanning weeks/months. Example: 'User Authentication & Security'\n"
    "   - **module**: Functional grouping of related features. Example: 'Payment Processing Module'\n"
    "   - **feature**: Detailed spec with requirements, scope, success criteria. Example: 'Social Login with Google/Facebook'\n"
    "   - **user_story**: User-centric requirement. Format: 'As a [persona], I want [goal] so that [benefit]'\n"
    "   - **cycle**: Sprint/iteration with goals and timeline. Example: 'Sprint 1: Auth Foundation - 2 weeks'\n"
    "   - **work_item**: Task, bug, or action item. Example: 'Implement OAuth2 callback handler'\n"
    "   - **page**: Documentation, meeting notes, specs. Example: 'API Documentation for Auth Module'\n"
