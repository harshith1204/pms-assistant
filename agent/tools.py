...
async def generate_content(
    ...
    """Generate project artifacts - sends content DIRECTLY to frontend, returns minimal confirmation.
    ...
    **CRITICAL TOKEN OPTIMIZATION**:
    ...
    Use this to create new content following the project hierarchy:
    - Projects: Overall project definitions and charters
    - Epics: Large initiatives spanning multiple features
    - Modules: Feature modules, components, subsystems
    - Features: Product features with detailed specifications
    - User Stories: User-centric requirements with acceptance criteria
    - Cycles: Sprints, iterations, development cycles
    - Work Items: Bugs, tasks, features, user stories
    ...
    Examples:
        ...
        generate_content(content_type="user_story", prompt="As a user, I want to reset my password")
        generate_content(content_type="feature", prompt="User Authentication System")
        generate_content(content_type="project", prompt="E-commerce Platform")
