...
export interface RawConversationMessage {
  ...
  page?: { title: string; blocks: { blocks: unknown[] }; isSaved?: boolean; savedData?: SavedArtifactData }; // eslint-disable-line @typescript-eslint/no-explicit-any
  ...
  feature?: { 
    ...
    functional_requirements?: Array<{ requirementId: string; priorityLevel: string; description: string }>;
    nonFunctionalRequirements?: Array<{ requirementId: string; priorityLevel: string; description: string }>; 
    non_functional_requirements?: Array<{ requirementId: string; priorityLevel: string; description: string }>;
    isSaved?: boolean; 
    savedData?: SavedArtifactData 
  };
  project?: { name?: string; project_name?: string; projectId?: string; project_id?: string; description?: string; isSaved?: boolean; savedData?: SavedArtifactData };
}
