...
import { Calendar, Wand2, Briefcase, Flag, CheckCircle } from \"lucide-react\";
...
export type EpicCreateInlineProps = {
  ...
  onSave?: (values: { title: string; description: string; project?: Project | null; startDate?: string; endDate?: string; status?: string; priority?: string }) => void;
  onDiscard?: () => void;
  className?: string;
