...
import { Calendar, Users, UserCircle, Layers, Wand2 } from "lucide-react";
    ...
    <Card className={cn("border-muted/70", className)}>
      <CardContent className="p-0">
        ...
        <div className="px-5 pt-3">
          <Label htmlFor="module-project-select" className="text-xs text-muted-foreground">Project</Label>
          <Select
            value={projectId}
            onValueChange={(v) => {
              setProjectId(v);
          ...
          >
            <SelectTrigger id="module-project-select" className="mt-1 h-9">
