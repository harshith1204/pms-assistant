...
export type ChatEvent =
  ...
  | { type: "agent_action"; text: string; step: number; action_id?: string; timestamp: string }
  | { type: "agent_result"; text: string; step: number; action_id?: string; timestamp: string }
