		...
		extend: {
			colors: {
				...
				'chat-bubble': {
					...
					thought: 'hsl(var(--chat-bubble-thought))',
					'thought-foreground': 'hsl(var(--chat-bubble-thought-foreground))',
					tool: 'hsl(var(--chat-bubble-tool))',
					'tool-foreground': 'hsl(var(--chat-bubble-tool-foreground))'
				},
				sidebar: {
