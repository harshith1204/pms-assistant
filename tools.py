...
# Composite tool for multi-step/tool-chaining queries (removed)
async def _composite_query_disabled(instruction: str = "", steps: Optional[List[Dict[str, Any]]] = None) -> str:
